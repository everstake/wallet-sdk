...
let RPC_URL = 'https://mainnet.infura.io/v3/0269ce2b62d248dcb7b6f2f80555e464';
...
function selectNetwork(network, url) {
    switch (network) {
        case 'mainnet':
            RPC_URL = url || 'https://mainnet.infura.io/v3/0269ce2b62d248dcb7b6f2f80555e464';
        ...
        case 'holesky':
            ...
            break;
        case 'goerli':
            RPC_URL = url || 'https://eth-goerli.public.blastapi.io';
